...
import (
	...
	"github.com/jcroyoaun/snackmath/internal/env"
	"github.com/jcroyoaun/snackmath/internal/version"
...
func run(logger *slog.Logger) error {
	...
	cfg.baseURL = env.GetString("BASE_URL", "http://localhost:7500")
	cfg.httpPort = env.GetInt("HTTP_PORT", 7500)
